...
immigrant.sd <- get_direction(pairs, wv = fastTM)
...
pdf("kline(2022_7_11)EP-img_fastTM_fig2.pdf")
sent_scores_plot_combined
dev.off()

pdf("kline(2022_7_11)EP-img_fastTM_fig3.pdf")
plot_group1_sent
dev.off()

pdf("kline(2022_7_11)EP-img_fastTM_fig4.pdf")
plot_group2_sent
dev.off()

pdf("kline(2022_7_11)EP-img_fastTM_fig5.pdf")
tidy_EP_chunks_combined_closeness_plot
dev.off()

pdf("kline(2022_7_11)EP-img_fastTM_fig6.pdf")
plot_group1_meaning
dev.off()

pdf("kline(2022_7_11)EP-img_fastTM_fig7.pdf")
plot_group2_meaning
dev.off()


pdf("kline(2022_7_11)EP-img_fastTM.pdf")
sent_scores_plot_combined
plot_group1_sent
plot_group2_sent
tidy_EP_chunks_combined_closeness_plot
...
sent_combined_fastTM  <- sent_scores_plot_combined
meaning_combined_fastTM <- tidy_EP_chunks_combined_closeness_plot

save(sent_combined_fastTM, file = "sent_combined_fastTM.Rdata")
save(meaning_combined_fastTM, file = "meaning_combined_fastTM.Rdata")
