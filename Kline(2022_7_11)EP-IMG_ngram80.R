...
immigrant.sd <- get_direction(pairs, wv = ngram_1980)
...
italian_closeness <- tidy_EP_chunks_italian %>% 
  cast_dtm(term = word, 
           ...
           weighting = tm::weightTf)  %>%
  removeSparseTerms(.999) %>%
  CMDist(cv = immigrant.sd, wv=ngram_1980 )
...
pdf("kline(2022_7_11)EP-img_ngram1980_fig2.pdf")
sent_scores_plot_combined
dev.off()

pdf("kline(2022_7_11)EP-img_ngram1980_fig3.pdf")
plot_group1_sent
dev.off()

pdf("kline(2022_7_11)EP-img_ngram1980_fig4.pdf")
plot_group2_sent
dev.off()

pdf("kline(2022_7_11)EP-img_ngram1980_fig5.pdf")
tidy_EP_chunks_combined_closeness_plot
dev.off()

pdf("kline(2022_7_11)EP-img_ngram1980_fig6.pdf")
plot_group1_meaning
dev.off()

pdf("kline(2022_7_11)EP-img_ngram1980_fig7.pdf")
plot_group2_meaning
dev.off()


pdf("kline(2022_7_11)EP-img_ngram1980.pdf")
sent_scores_plot_combined
plot_group1_sent
plot_group2_sent
tidy_EP_chunks_combined_closeness_plot
...
sent_combined_ngram1980  <- sent_scores_plot_combined
meaning_combined_ngram1980 <- tidy_EP_chunks_combined_closeness_plot

save(sent_combined_ngram1980, file = "sent_combined_ngram1980.Rdata")
save(meaning_combined_ngram1980, file = "meaning_combined_ngram1980.Rdata")
