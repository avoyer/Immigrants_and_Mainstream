...
# File Name:Kline(2022_7_11)ep-img_centroid__2022_7_11_
# Date:     txt_2022_3_28
...
additions <- c("normal","citizen","american")
subtracts  <- c("strange","immigrant","foreign")
...
pdf("kline(2022_7_11)ep-img_centroid_fig2.pdf")
sent_scores_plot_combined
dev.off()

pdf("kline(2022_7_11)ep-img_centroid_fig3.pdf")
plot_group1_sent
dev.off()

pdf("kline(2022_7_11)ep-img_centroid_fig4.pdf")
plot_group2_sent
dev.off()

pdf("kline(2022_7_11)ep-img_centroid_fig5.pdf")
tidy_EP_chunks_combined_closeness_plot
dev.off()

pdf("kline(2022_7_11)ep-img_centroid_fig6.pdf")
plot_group1_meaning
dev.off()

pdf("kline(2022_7_11)ep-img_centroid_fig7.pdf")
plot_group2_meaning
dev.off()


pdf("kline(2022_7_11)ep-img_centroid.pdf")
sent_scores_plot_combined
plot_group1_sent
plot_group2_sent
tidy_EP_chunks_combined_closeness_plot
...
figure_E1  <- plot_group1_meaning
figure_E2 <- plot_group2_meaning

save(figure_E1, file = "figure_E1.Rdata")
save(figure_E2, file = "figure_E2.Rdata")
